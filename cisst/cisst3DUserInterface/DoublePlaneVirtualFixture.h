...
public:
    ...
    /*! @brief DoublePlaneVirtualFixture contructor that takes
    *   no argument
    */
    DoublePlaneVirtualFixture(void);

    /*! @brief DoublePlaneVirtualFixture contructor that takes base
    *   points and plane normal vectors for upper and lower planes
    *   and sets them.
    *
    *   @param base1 base point for the first plane.
    *   @param base2 base point for the second plane.
    *   @param planeNormal1 plane normal vector for the first plane.
    *   @param planeNormal2 plane normal vector for the second plane.
    */
    DoublePlaneVirtualFixture(vct3 base1, vct3 base2, vct3 planeNormal1, vct3 planeNormal2);
    ...
    *   @param planeBasePoint base point in the plane.
    *   @return closest point to the plane.
    */
    vct3 closestPoint(vct3 point , vct3 planeNormal , vct3 planeBasePoint);
    ...
    */
    double shortestDistance(vct3 point , vct3 planeNormal, vct3 planeBasePoint);

    /*! @brief Sets the base point vector for the first plane.
    *
    *   @param base1 base point.
    */
    void setBasePoint1(const vct3 & base1);

    /*! @brief Sets the unit normal vector for the first plane.
    *
    *   @param planeNormal1 unit normal vector.
    */
    void setPlaneNormal1(const vct3 & planeNormal1);

    /*! @brief Sets the base point vector for the second plane.
    *
    *   @param base2 base point.
    */
    void setBasePoint2(const vct3 & base2);

    /*! @brief Sets the unit normal vector for the second plane.
    *
    *   @param planeNormal2 unit normal vector.
    */
    void setPlaneNormal2(const vct3 & planeNormal2);

    /*! @brief Returns the base point for the upper plane.
    *
    *   @return basePoint1
    */
    vct3 getBasePoint1(void);

    /*! @brief Returns the base point for the lower plane.
    *
    *   @return basePoint2
    */
    vct3 getBasePoint2(void);

    /*! @brief Returns the norm vector for the upper plane.
    *
    *   @return normVector1
    */
    vct3 getPlaneNormal1(void);

    /*! @brief Returns the norm vector for the lower plane.
    *
    *   @return normVector2
    */
    vct3 getPlaneNormal2(void);
...
protected:
    ...
    vct3 planeNormal1;  //!< Unit normal vector for the first plane.
    vct3 planeNormal2;  //!< Unit normal vector for the second plane.
