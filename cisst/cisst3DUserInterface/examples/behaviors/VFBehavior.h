...
/*
  $Id: MapBehavior.h 3148 2011-11-07 22:44:31Z adeguet1 $
...
class CISST_EXPORT VFBehavior: public ui3BehaviorBase
{
    ...
    protected:
        ...
        prmPositionCartesianGet currentMTMRPosition; //MTMR position and orientation
        ...
        prmFixtureGainCartesianSet testVF;
