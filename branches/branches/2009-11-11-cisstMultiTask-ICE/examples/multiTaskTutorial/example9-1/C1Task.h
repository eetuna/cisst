...
/* $Id: C1Task.h 781 2009-09-01 14:23:50Z adeguet1 $ */
...
class C1Task: public mtsTaskPeriodic {
    // set log level to 5
...
public:
    ...
    C1Task(const std::string & taskName, double period);
    ~C1Task() {};
...
CMN_DECLARE_SERVICES_INSTANTIATION(C1Task);
