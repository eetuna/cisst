...
module mtsManagerProxy
{
	...
	interface ManagerClient
	{
        ...
        //-------------------------------------------------
        ["cpp:const"] idempotent
        bool GetProvidedInterfaceDescription(string componentName, string providedInterfaceName, ProvidedInterfaceDescription providedInterface);
        ["cpp:const"] idempotent
        bool GetRequiredInterfaceDescription(string componentName, string requiredInterfaceName, RequiredInterfaceDescription requiredInterface);
        ["cpp:const"] idempotent
        string GetProcessName();
        ["cpp:const"] idempotent
        int GetCurrentInterfaceCount(string componentName);
	...
	interface ManagerServer
	{
        ...
        //-------------------------------------------------
        bool SetProvidedInterfaceProxyAccessInfo(ConnectionStringSet connectionStrings, string endpointInfo, string communicatorID);
        bool GetProvidedInterfaceProxyAccessInfo(ConnectionStringSet connectionStrings, string endpointInfo, string communicatorID);
        bool GetProvidedInterfaceProxyAccessInfo(string serverProcessName, string serverComponentName, string serverProvidedInterfaceName, string endpointInfo, string communicatorID);
        bool InitiateConnect(int connectionID, ConnectionStringSet connectionStrings);
        bool ConnectServerSideInterface(int providedInterfaceProxyInstanceId, ConnectionStringSet connectionStrings);
