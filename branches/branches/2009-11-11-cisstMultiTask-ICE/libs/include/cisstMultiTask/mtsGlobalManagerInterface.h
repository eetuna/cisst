...
/*
  $Id: mtsGlobalManagerInterface.h 794 2009-09-01 21:43:56Z pkazanz1 $
...
/*!
  \file
  \brief Definition of mtsGlobalManagerInterface
  ...
  Standalone Mode: Inter-thread communication, no ICE.  Local task manager 
    ...
    In this case, mtsTaskManager::GlobalManager is of type mtsGlobalManager.
  ...
  Network mode: Inter-process communication, ICE enabled.  Local task manager
    ...
    In this case, mtsTaskManager::GlobalManager is of type mtsGlobalManagerProxyClient.

  \note Please refer to mtsGlobalManager and mtsGlobalManagerProxyClient  as well.
*/

#ifndef _mtsGlobalManagerInterface_h
#define _mtsGlobalManagerInterface_h

#include <cisstCommon/cmnGenericObject.h>

class CISST_EXPORT mtsGlobalManagerInterface : public cmnGenericObject {
...
#endif // _mtsGlobalManagerInterface_h
