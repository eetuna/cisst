...
if(CISSTNETLIB_DIR) 
  ...
  find_library(CISSTNETLIB_GFORTRAN_LIBRARY cisstNetlibgfortran ${CISSTNETLIB_DIR}/lib ${CISSTNETLIB_DIR})
#  set(CISSTNETLIB_LIBRARIES ${CISSTNETLIB_LIBRARY} )
  set(CISSTNETLIB_LIBRARIES ${CISSTNETLIB_LIBRARY} ${CISSTNETLIB_GFORTRAN_LIBRARY})
  mark_as_advanced(CISSTNETLIB_LIBRARY CISSTNETLIB_GFORTRAN_LIBRARY)
  if(WIN32)
