...
/* $Id: displayTaskOmniServer.h 75 2009-02-24 16:47:20Z adeguet1 $ */

#ifndef _displayTaskOmniServer_h
#define _displayTaskOmniServer_h
...
class displayTaskOmniServer: public mtsTaskPeriodic {
    // set log level to 5
 ...
 public:
    ...
    displayTaskOmniServer(const std::string & taskName, double period);
    ~displayTaskOmniServer() {};
...
CMN_DECLARE_SERVICES_INSTANTIATION(displayTaskOmniServer);

#endif // _displayTaskOmniServer_h
