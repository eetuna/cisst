...
/* $Id: displayTask4GTM.h 75 2009-02-24 16:47:20Z adeguet1 $ */

#ifndef _displayTask4GTM_h
#define _displayTask4GTM_h
...
class displayTask4GTM: public mtsTaskPeriodic {
    // set log level to 5
 ...
 public:
    ...
    displayTask4GTM(const std::string & taskName, double period);
    ~displayTask4GTM() {};
...
CMN_DECLARE_SERVICES_INSTANTIATION(displayTask4GTM);

#endif // _displayTask4GTM_h
