...
#else  // PK TEMP
MTS_IMPLEMENT_SERVICES_PROXY(mtsDouble)
MTS_IMPLEMENT_SERVICES_PROXY(mtsLong)
MTS_IMPLEMENT_SERVICES_PROXY(mtsULong)
MTS_IMPLEMENT_SERVICES_PROXY(mtsInt)
MTS_IMPLEMENT_SERVICES_PROXY(mtsUInt)
MTS_IMPLEMENT_SERVICES_PROXY(mtsShort)
MTS_IMPLEMENT_SERVICES_PROXY(mtsUShort)
MTS_IMPLEMENT_SERVICES_PROXY(mtsChar)
MTS_IMPLEMENT_SERVICES_PROXY(mtsUChar)
MTS_IMPLEMENT_SERVICES_PROXY(mtsBool)
MTS_IMPLEMENT_SERVICES_PROXY(mtsStdString)
#endif
